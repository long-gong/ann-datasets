function im = read_tiny_gist_binary(words_in,ind,varargin)
%
...
% if isempty(varargin)
    ...
    binary_fname = '../../Euclidean/tiny/tinygist80million.bin';
    % indexing info .mat file
    binary_data_fname = '../../Euclidean/tiny/tiny_index.mat';
% else
%     binary_fname = varargin{1};
%     binary_data_fname = varargin{2};
% end
% total # imgs
